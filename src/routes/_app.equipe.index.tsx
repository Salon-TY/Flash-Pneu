        ...
        {created ? (
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-muted-foreground">
                Seuls les techniciens (et vous) apparaissent parmi les personnes assignables sur le terrain.
              </p>
            </div>
        ...
        <div className="mt-3 space-y-3">
          ...
          {isTechnicien && (
            <p className="text-xs text-muted-foreground italic bg-muted/40 rounded-md px-3 py-2">
              Les techniciens ont une interface dédiée (Ma journée / Mon camion).
