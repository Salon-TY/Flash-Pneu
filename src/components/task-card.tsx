// Ligne "rendez-vous/site" générique — client, type, adresse (lien carte),
// appel direct. Rien d'équivalent en Phase A/B (StatCard est pour une
// métrique, pas une ligne de rendez-vous avec action d'appel). Composant
// socle : pas de vocabulaire métier, la couche métier lui fournit ses
// propres données.
