...
function FactureDetail() {
  ...
  .meta-left .name { font-size:14px; font-weight:bold; color:#1a1a1a; margin-bottom:3px; }
  .meta-left .addr { font-size:10px; color:#6b7280; line-height:1.6; }
  .meta-right      { text-align:right; }
  .meta-right .num { font-size:28px; font-weight:bold; color:#1a1a1a; line-height:1; }
  .badge {
  ...
  .rib strong { display:block; color:#1a1a1a; font-size:11px; margin-bottom:3px; }
