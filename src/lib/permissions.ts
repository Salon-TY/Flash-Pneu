export type PermissionKey =
  ...
  | "interventions" | "planning" | "vehicules" | "analytique";
...
export const PRESET_BUREAU: PermissionKey[] = [
  "accueil", "clients", "devis", "factures", "reappro",
  "interventions", "planning", "vehicules",
];
