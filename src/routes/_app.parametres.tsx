...
import { useSettings, useMyAccess } from "@/lib/queries";
...
function ParametresPage() {
  ...
  async function handleExport() {
    setExporting(true);
    try {
      const [clients, invoices, invoiceLines, stock, stockLevels, teamMembers] = await Promise.all([
      ...
      XLSX.writeFile(wb, `sauvegarde-${date}.xlsx`);
